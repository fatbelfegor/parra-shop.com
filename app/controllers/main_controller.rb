...
class MainController < ApplicationController
  ...
  def matras
    @title = "Москве от интернет магазина Parra-Shop"
    @seo_description = "В интернет магазине Parra-Shop можно купить европейский матрас. Купить матрас в Москве и области."
    @seo_keywords = "Европейские, матрасы, купить, ортопедический, матрас, Москве, интернет, магазина, Parra-Shop"
  end
